...
Item {
  ...
  property string customCmdGetNumUpdates: ""
  property string customCmdDoSystemUpdate: ""
  property string updateTerminalCommand: "foot -e"
  ...
  property var customUpdater: ({
    name: "custom",
    cmdGetNumUpdates: root.customCmdGetNumUpdates,
    cmdDoSystemUpdate: root.customCmdDoSystemUpdate
  })
  ...
  function startDoSystemUpdate() {
    ...
    const fullCmd = (term.indexOf("{}") !== -1) ? term.replace("{}", updateCmd) : term + " " + updateCmd;
